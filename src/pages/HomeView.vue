            ...
            <section :class="{ 'pointer-events-none select-none opacity-75': isGuest }">
              ...
              <div class="mt-4 overflow-hidden rounded-xl border border-slate-300 bg-white">
                <div
                  ...
                  :key="product.id"
                  class="order-edit grid gap-3 border-b-2 border-slate-300 p-4 last:border-b-0 sm:grid-cols-[minmax(0,2.4fr)_4.5rem_5.5rem_6.25rem_4.75rem_10rem] sm:items-end"
                >
