            ...
            <section :class="{ 'pointer-events-none select-none opacity-75': isGuest }">
              ...
              <div class="mt-4 overflow-hidden rounded-xl border border-slate-300 bg-white">
                <div
                  ...
                  :key="product.id"
                  class="order-edit grid gap-2 border-b-2 border-slate-300 p-4 last:border-b-0 sm:grid-cols-[minmax(14rem,1fr)_3.25rem_3.75rem_4rem_4.2rem_4.2rem_7.5rem] sm:items-end"
                >
                  ...
                  <div class="text-xs font-medium text-slate-500">Итого, ₴<strong class="mt-1 block rounded-lg border border-slate-200 bg-slate-50 px-2 py-1.5 text-sm text-slate-900">{{ formatMoney(getProductAmount(product)) }}</strong></div>
